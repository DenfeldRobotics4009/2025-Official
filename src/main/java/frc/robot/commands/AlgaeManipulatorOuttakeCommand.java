...
public AlgaeManipulatorOuttakeCommand(AlgaeManipulatorSubsystem m_algAlgaeManipulatorSubsystem) {
    this.m_AlgaeManipulatorSubsystem = m_algAlgaeManipulatorSubsystem;
